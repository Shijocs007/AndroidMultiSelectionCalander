...
public class CalanderVerticalFragment extends Fragment implements ICalenderClickListener {
    ...
    private void setCalanderLayout() {

        int startMonth  =   MultiCalendarManager.getInstance().getStartCalender().get(Calendar.MONTH);
        int endDateMonth = 12;
        if (MultiCalendarManager.getInstance().getEndDate() == null){
            endDateMonth =startMonth + 12;
        }else{
            if (MultiCalendarManager.getInstance().getEndDate().get(Calendar.YEAR) == MultiCalendarManager.getInstance().getStartCalender().get(Calendar.YEAR)){
                endDateMonth = MultiCalendarManager.getInstance().getEndDate().get(Calendar.MONTH);
            }
            else {
                endDateMonth = 12+MultiCalendarManager.getInstance().getEndDate().get(Calendar.MONTH);
            }
        }
        int monthDiff = endDateMonth - startMonth;
        if(MultiCalendarManager.getInstance().getEndDate() == null){
