 ...
 */
public class CalenderView1 extends Fragment {
    ...
    public CalenderView1() {
        this.tittleListener = MultiCalendarManager.getInstance().getiCalenderTittleListener();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        leftBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tittleListener.onLeftButtonClicked(1);
            }
        });
        ...
        rightBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              tittleListener.onRightButtonClicked(1);
            }
        });
    ...
    private void setCalander() {
        ...
        int start_date  =  new Date(MultiCalendarManager.getInstance().getStartCalender().getTimeInMillis()).getDate();
...
//            }
            ...
            if(MultiCalendarManager.getInstance().isClickable()) {
                if (dateTag < start_date || dateTag > end_date) {
                    ...
                    if (MultiCalendarManager.getInstance().getSelectedDates().contains(date_check)) {
                        MultiCalendarManager.getInstance().getSelectedDates().remove(date_check);
